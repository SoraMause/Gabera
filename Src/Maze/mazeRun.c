  ...
  while( motion_queue[motion_last] != 0 ){
    switch( motion_queue[motion_last] ){
      ...
      case DIA_LEFT_TURN:
        ...
        if ( translation_ideal.distance < 15.0f ) translation_ideal.distance = 7.0f;
  ...
  while( motion_queue[motion_last] != 0 ){
    switch( motion_queue[motion_last] ){
      ...
      case DIA_CENTER_LEFT:
        ...
        sidewall_control_flag = 1;
        while( sen_l.now > sen_l.threshold );
        if ( translation_ideal.distance < 10.0f ) translation_ideal.distance = 8.5f;
      ...
      case DIA_LEFT_TURN:
        fullColorLedOut( 0x06 );
        dirwall_control_flag = 1;
        while( sen_l.now > sen_l.threshold && translation_ideal.distance < 9.0f );
        if ( translation_ideal.distance < 9.0f ) translation_ideal.distance = 5.1f;
      ...
      case DIA_RIGHT_TURN:
        fullColorLedOut( 0x06 );
        dirwall_control_flag = 1;
        while( sen_r.now > sen_r.threshold && translation_ideal.distance < 9.0f );
        if ( translation_ideal.distance < 9.0f ) translation_ideal.distance = 5.1f;
        setStraight( 11.0f, 0.0f, 1700.0f, 1700.0f, 1700.0f );
        waitStraight();
        setRotation( -90.0f, 40000.0f, 1200.0f, 1700.0f );
...
void adachiFastRunDiagonal1800( t_normal_param *translation, t_normal_param *rotation )
{
  // k = 300
  setControlFlag( 0 );
  setLogFlag( 0 );
  ...
  while( motion_queue[motion_last] != 0 ){
    switch( motion_queue[motion_last] ){
      ...
      case CENRTER_SLAROM_LEFT:
        ...
        sidewall_control_flag = 1;
        while( sen_l.now > sen_l.threshold );
        if ( translation_ideal.distance < 15.0f ) translation_ideal.distance = 9.0f;
        setStraight( 19.0f, translation->accel, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
        setRotation( 90.0f, 20000.0f, 1000.0f, 1800.0f);
        waitRotation();
        sidewall_control_flag = 1;
        setStraight( 39.0f, 0.0f, 1800.0f, 1800.0f, 1800.0f);
        waitStraight();
        break;
      ...
      case SLAROM_LEFT_180:
        ...
        while( sen_l.now > sen_l.threshold );
        if ( translation_ideal.distance < 15.0f ) translation_ideal.distance = 9.0f;
        setStraight( 25.0f, translation->accel, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
        setRotation( 180.0f, 26000.0f, 1200.0f, 1800.0f );
        waitRotation();
        sidewall_control_flag = 1;
        setStraight( 41.0f, 0.0f, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
        break;
      ...
      case DIA_CENTER_LEFT:
        fullColorLedOut( 0x04 );
        sidewall_control_flag = 1;
        while( sen_l.now > sen_l.threshold && translation_ideal.distance < 11.0f );
        if ( translation_ideal.distance < 11.0f ) translation_ideal.distance = 9.0f;
        setStraight( 11.0f, translation->accel, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
        setRotation( 45.0f, 35000.0f, 1000.0f, 1800.0f );
        waitRotation();
        dirwall_control_flag = 1;
        setStraight( 65.0f, 0.0f, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
        break;
      ...
      case DIA_CENTER_RIGHT:
        fullColorLedOut( 0x04 );
        sidewall_control_flag = 1;
        while( sen_r.now > sen_r.threshold && translation_ideal.distance < 11.0f );
        if ( translation_ideal.distance < 11.0f ) translation_ideal.distance = 9.0f;
        setStraight( 11.0f, translation->accel, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
        setRotation( -45.0f, 35000.0f, 1000.0f, 1800.0f );
      ...
      case DIA_LEFT_TURN:
        fullColorLedOut( 0x06 );
        dirwall_control_flag = 1;
        while( sen_l.now > sen_l.threshold && translation_ideal.distance < 5.0f );
        if ( translation_ideal.distance < 5.0f ) translation_ideal.distance = 3.6f;
        setStraight( 7.0f, 0.0f, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
        setRotation( 90.0f, 45000.0f, 1200.0f, 1800.0f );
        waitRotation();
        dirwall_control_flag = 1;
        setStraight( 26.0f, 0.0f, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
        break;
      ...
      case DIA_RIGHT_TURN:
        fullColorLedOut( 0x06 );
        dirwall_control_flag = 1;
        while( sen_r.now > sen_r.threshold && translation_ideal.distance < 5.0f );
        if ( translation_ideal.distance < 5.0f ) translation_ideal.distance = 3.6f;
        setStraight( 7.0f, 0.0f, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
        setRotation( -90.0f, 45000.0f, 1200.0f, 1800.0f );
      ...
      case RETURN_DIA_LEFT:
        ...
        if ( translation_ideal.distance < 10.0f ) translation_ideal.distance = 3.6f;
        setStraight( 37.0f, 0.0f, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
      ...
      case RETURN_DIA_LEFT_135:
        fullColorLedOut( 0x07 );
        dirwall_control_flag = 1;
        while( sen_l.now > sen_l.threshold && translation_ideal.distance < 7.0f );
        if ( translation_ideal.distance < 7.0f ) translation_ideal.distance = 3.6f;
        setStraight( 7.0f, 0.0f, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
      ...
      case RETURN_DIA_RIGHT_135:
        fullColorLedOut( 0x07 );
        dirwall_control_flag = 1;
        while( sen_r.now > sen_r.threshold && translation_ideal.distance < 7.0f );
        if ( translation_ideal.distance < 7.0f ) translation_ideal.distance = 3.6f;
